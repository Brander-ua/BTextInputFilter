//
//  DigitsOnlyCharacterSetTextInputFilterTests.swift
...
class DigitsOnlyCharacterSetTextInputFilterTests: XCTestCase {

  private let filter = CharacterSetTextInputFilter(characterSet: CharacterSet.decimalDigits)
